...
def get_args():
    ...
    parser.add_argument('--sparse_feature_info', type=list,
                        default=[('userid', 20000, 10), ('feedid', 106444, 10),
    ...
    parser.add_argument('--keyword_vocab_path', type=str, default=os.path.join(KW_TAG_VOCAB_PATH, 'keyword_token2id.json'))
    parser.add_argument('--keyword_vocab_size', type=int, default=14256)
    parser.add_argument('--tag_vocab_path', type=str, default=os.path.join(KW_TAG_VOCAB_PATH, 'tag_token2id.json'))
    ...
    parser.add_argument('--action', type=str, default='',
                        help='multi-task or multiple single task. `single` mean the latter, '
                             'empty string mean the former')
    parser.add_argument('--debug_data', action='store_true')
    parser.add_argument('--single_task_exp', type=str, default='')
